...
// Initialize the game
const backgroundMusic = new Audio('gamemusic.mp3'); // Ensure the file is in your project directory
backgroundMusic.loop = true; // Enable looping for continuous play
backgroundMusic.volume = 0.5; // Set a reasonable volume level
...
const placeSound = new Audio('place.wav'); // Ensure the file is in your project directory
...
const lineClearSound = new Audio('cleared.wav'); // Ensure the file is in your project directory
...
function gameOver() {
    ...
    backgroundMusic.currentTime = 0; // Reset to the beginning for the next game
}
